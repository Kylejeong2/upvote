...
// Original Stagehand implementation (commented out)
/*
...
export async function main({
  ...
  try {
    ...
    // Try to take a screenshot to debug the issue
    try {
      await page.screenshot({ path: 'error-screenshot.png' });
      console.log(chalk.yellow("Screenshot saved as error-screenshot.png"));
    } catch (screenshotError) {
      console.log(chalk.red("Failed to take error screenshot"));
    }
  }
